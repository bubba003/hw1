<?php
    ...
    if(strcmp($type, "all") == 0){
        ...
        $query="SELECT * FROM PREFERITI WHERE USERNAME='$username' AND TIPOLOGIA='$type'";
    }
    ...
    if(mysqli_num_rows($result) >0){
        ...
        echo json_encode(array("success" => true, "preferiti" => $array));
    }
    else{//cioè l'utente non ha elementi nei preferiti
